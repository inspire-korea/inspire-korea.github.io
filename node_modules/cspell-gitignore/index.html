...
<span class="kd">const</span> <span class="nx">root</span> <span class="o">=</span> <span class="p">(</span><span class="k">await</span> <span class="nx">findRepoRoot</span><span class="p">(</span><span class="nx">cwd</span><span class="p">))</span> <span class="o">||</span> <span class="nx">cwd</span><span class="p">;</span>
<span class="kd">const</span> <span class="nx">gitIgnore</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">GitIgnore</span><span class="p">([</span><span class="nx">root</span><span class="p">]);</span>

<span class="kd">const</span> <span class="nx">allFiles</span> <span class="o">=</span> <span class="nx">glob</span><span class="p">(</span><span class="dl">'</span><span class="s1">**</span><span class="dl">'</span><span class="p">);</span>

<span class="kd">const</span> <span class="nx">files</span> <span class="o">=</span> <span class="k">await</span> <span class="nx">gitIgnore</span><span class="p">.</span><span class="nx">filterOutIgnored</span><span class="p">(</span><span class="nx">allFiles</span><span class="p">);</span>
</code></pre></div></div><h2 id="logic">Logic</h2><ul><li>For each file, search for the <code class="language-plaintext highlighter-rouge">.gitignore</code> files in the directory hierarchy.</li><li>Ignore any files that match the globs found in the <code class="language-plaintext highlighter-rouge">.gitignore</code> files.</li></ul><p>The <code class="language-plaintext highlighter-rouge">.gitignore</code> globs are evaluated from highest to lowest, matching the <code class="language-plaintext highlighter-rouge">git</code> behavior.</p><p>To prevent searching higher in the directory hierarchy, specify roots:</p><div class="language-ts highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">gitIgnore</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">GitIgnore</span><span class="p">([</span><span class="nx">process</span><span class="p">.</span><span class="nx">cwd</span><span class="p">()]);</span>
</code></pre></div></div><h1 id="cspell-gitignore-cli"><code class="language-plaintext highlighter-rouge">cspell-gitignore</code> CLI</h1><p><code class="language-plaintext highlighter-rouge">cspell-gitignore</code> provides a simple cli for debugging .gitignore issues.</p><p>In most cases it should provide the same output as <code class="language-plaintext highlighter-rouge">git check-ignore</code>.</p><h2 id="usage-1">Usage</h2><div class="language-text highlighter-rouge"><div class="highlight"><pre class="highlight"><code>Usage cspell-gitignore [options] &lt;files&gt;
...
</code></pre></div></div><h2 id="example">Example:</h2><div class="language-sh highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nv">$ </span>cspell-gitignore <span class="nt">-r</span> <span class="nb">.</span> node_modules
.gitignore:58:node_modules/       node_modules
</code></pre></div></div></div></div></div><footer><div class="container"><div class="row"><div class="col-lg-8 col-md-10 mx-auto share-title"> SHARE </div><div class="col-lg-8 col-md-10 mx-auto"><ul class="list-inline text-center"><li class="list-inline-item"><a href="https://twitter.com/intent/tweet?text=cspell-gitignore&url=https://ink.posstree.com/node_modules/cspell-gitignore/" rel="nofollow noreferrer noopener" target="_blank"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-twitter fa-stack-1x fa-inverse"></i></span><div style="width: 0; height: 0; overflow: hidden; float: left;"> Twitter </div></a></li><li class="list-inline-item"><a href="https://www.facebook.com/sharer/sharer.php?u=https://ink.posstree.com/node_modules/cspell-gitignore/" rel="nofollow noreferrer noopener" target="_blank"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-facebook fa-stack-1x fa-inverse"></i></span><div style="width: 0; height: 0; overflow: hidden; float: left;"> Facebook </div></a></li><li class="list-inline-item"><a href="https://ink.posstree.com/feed.xml" rel="nofollow noreferrer noopener" target="_blank"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-rss-square fa-stack-1x fa-inverse" aria-hidden="true"></i></span><div style="width: 0; height: 0; overflow: hidden; float: left;"> RSS </div></a></li></ul><p class="copyright text-muted"> Copyright &copy; dev.yakuza@gmail.com 2025 </p></div></div></div></footer><script src="/assets/vendor/jquery/jquery.min.js"></script><script src="/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script><script src="/assets/vendor/startbootstrap-clean-blog/js/clean-blog.min.js"></script><script src="/assets/scripts.js?v=20250113"></script><link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@9.17.1/build/styles/railscasts.min.css"></body></html>