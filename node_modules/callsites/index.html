...
</code></pre></div></div><h2 id="api">API</h2><p>Returns an array of callsite objects with the following methods:</p><ul><li><code class="language-plaintext highlighter-rouge">getThis</code>: returns the value of <code class="language-plaintext highlighter-rouge">this</code>.</li><li><code class="language-plaintext highlighter-rouge">getTypeName</code>: returns the type of <code class="language-plaintext highlighter-rouge">this</code> as a string. This is the name of the function stored in the constructor field of <code class="language-plaintext highlighter-rouge">this</code>, if available, otherwise the object’s <code class="language-plaintext highlighter-rouge">[[Class]]</code> internal property.</li><li><code class="language-plaintext highlighter-rouge">getFunction</code>: returns the current function.</li><li><code class="language-plaintext highlighter-rouge">getFunctionName</code>: returns the name of the current function, typically its <code class="language-plaintext highlighter-rouge">name</code> property. If a name property is not available an attempt will be made to try to infer a name from the function’s context.</li><li><code class="language-plaintext highlighter-rouge">getMethodName</code>: returns the name of the property of <code class="language-plaintext highlighter-rouge">this</code> or one of its prototypes that holds the current function.</li><li><code class="language-plaintext highlighter-rouge">getFileName</code>: if this function was defined in a script returns the name of the script.</li><li><code class="language-plaintext highlighter-rouge">getLineNumber</code>: if this function was defined in a script returns the current line number.</li><li><code class="language-plaintext highlighter-rouge">getColumnNumber</code>: if this function was defined in a script returns the current column number</li><li><code class="language-plaintext highlighter-rouge">getEvalOrigin</code>: if this function was created using a call to <code class="language-plaintext highlighter-rouge">eval</code> returns a string representing the location where <code class="language-plaintext highlighter-rouge">eval</code> was called.</li><li><code class="language-plaintext highlighter-rouge">isToplevel</code>: is this a top-level invocation, that is, is this the global object?</li><li><code class="language-plaintext highlighter-rouge">isEval</code>: does this call take place in code defined by a call to <code class="language-plaintext highlighter-rouge">eval</code>?</li><li><code class="language-plaintext highlighter-rouge">isNative</code>: is this call in native V8 code?</li><li><code class="language-plaintext highlighter-rouge">isConstructor</code>: is this a constructor call?</li></ul><h2 id="license">License</h2><p>MIT © <a href="https://sindresorhus.com">Sindre Sorhus</a></p></div></div></div><footer><div class="container"><div class="row"><div class="col-lg-8 col-md-10 mx-auto share-title"> SHARE </div><div class="col-lg-8 col-md-10 mx-auto"><ul class="list-inline text-center"><li class="list-inline-item"><a href="https://twitter.com/intent/tweet?text=callsites&url=https://ink.posstree.com/node_modules/callsites/" rel="nofollow noreferrer noopener" target="_blank"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-twitter fa-stack-1x fa-inverse"></i></span><div style="width: 0; height: 0; overflow: hidden; float: left;"> Twitter </div></a></li><li class="list-inline-item"><a href="https://www.facebook.com/sharer/sharer.php?u=https://ink.posstree.com/node_modules/callsites/" rel="nofollow noreferrer noopener" target="_blank"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-facebook fa-stack-1x fa-inverse"></i></span><div style="width: 0; height: 0; overflow: hidden; float: left;"> Facebook </div></a></li><li class="list-inline-item"><a href="https://ink.posstree.com/feed.xml" rel="nofollow noreferrer noopener" target="_blank"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-rss-square fa-stack-1x fa-inverse" aria-hidden="true"></i></span><div style="width: 0; height: 0; overflow: hidden; float: left;"> RSS </div></a></li></ul><p class="copyright text-muted"> Copyright &copy; dev.yakuza@gmail.com 2025 </p></div></div></div></footer><script src="/assets/vendor/jquery/jquery.min.js"></script><script src="/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script><script src="/assets/vendor/startbootstrap-clean-blog/js/clean-blog.min.js"></script><script src="/assets/scripts.js?v=20250114"></script><link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@9.17.1/build/styles/railscasts.min.css"></body></html>